...
import { DataStore, StreamSplitter, Upload, ERRORS, TUS_RESUMABLE, MemoryKvStore, } from '@tus/utils';
    ...
    async deleteExpired() {
        ...
        while (isTruncated) {
            ...
            const objectsToDelete = expiredUploads.reduce((all, expiredUpload) => {
                all.push({
                    key: this.infoKey(expiredUpload.Key),
                }, {
                    key: this.partKey(expiredUpload.Key, true),
                });
                return all;
            }, []);
            const deletions = [];
